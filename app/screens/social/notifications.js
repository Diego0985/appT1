...
export class Notifications extends React.Component {
	...
	renderRow(row) {
		...
		return (
			<View style={styles.container}>
				<Avatar img={row.user.photo} rkType="circle" style={styles.avatar} badge={row.type} />
	...
	render() {
		return <ListView style={styles.root} dataSource={this.data} renderRow={this.renderRow} />;
	}
}
